...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o: ../python/caffe/_caffe.cpp
	...
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o -c /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/_caffe.cpp
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i: cmake_force
	...
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/_caffe.cpp > CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s: cmake_force
	...
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/_caffe.cpp -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s
...
lib/_caffe.so: /media/SSD/zhoulei/workspace/Tools/openmpi/lib/libmpi_cxx.so
lib/_caffe.so: /media/SSD/zhoulei/workspace/Tools/openmpi/lib/libmpi.so
...
lib/_caffe.so: python/CMakeFiles/pycaffe.dir/link.txt
	...
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pycaffe.dir/link.txt --verbose=$(VERBOSE)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "Creating symlink /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/_caffe.so -> /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/lib/_caffe.so"
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && ln -sf /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/lib/_caffe.so /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/_caffe.so
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && /usr/bin/cmake -E make_directory /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/proto
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && touch /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/proto/__init__.py
	cd /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/python && cp /media/SSD/zhoulei/workspace/Caffes/caffe_nd/build_cmake/include/caffe/proto/*.py /media/SSD/zhoulei/workspace/Caffes/caffe_nd/python/caffe/proto/
